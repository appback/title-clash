  ...
  return (
    <div className="container animate-fade-in">
      ...
      <div style={{ maxWidth: '400px', margin: '0 auto' }}>
        <a href="https://appback.app/api/v1/auth/google?redirect=https://titleclash.com/auth/callback"
          className="btn btn-lg" style={{ width: '100%', marginBottom: '12px', background: '#fff', color: '#444', border: '1px solid #ddd', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', textDecoration: 'none' }}>
        ...
        <a href="https://appback.app/api/v1/auth/github?redirect=https://titleclash.com/auth/callback"
          className="btn btn-lg" style={{ width: '100%', marginBottom: '16px', background: '#24292e', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', textDecoration: 'none' }}>
        ...
        <div style={{ textAlign: 'center', margin: '12px 0', color: 'var(--text-muted)', fontSize: '13px' }}>or</div>
      </div>
